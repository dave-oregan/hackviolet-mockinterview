...
// [FIX] Ensure this is exported as DEFAULT
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    const activeColors = (colors || []).filter(Boolean).slice(0, MAX_COLORS).map(toVec3);
    activeColors.forEach((c, i) => uColorsArray[i].copy(c));
